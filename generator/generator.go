...
func (g *Generator) genUpdate(t *Table) {
	...
	g.Pn("func (dao *%sDao)Update(ctx context.Context,tx *runtime.Tx,e *%s)(err error){", t.GoName, t.GoName)
...
func (g *Generator) genDelete(t *Table) {
	g.Pn("func (dao *%sDao)Delete(ctx context.Context,tx *runtime.Tx,%s %s)(err error){", t.GoName, t.PrimaryColumn.DbName, t.PrimaryColumn.GoType)
